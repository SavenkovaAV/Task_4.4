...
public class SortDemoFrame extends JFrame {
    ...
    private JButton buttonShellSort;
    ...
    public SortDemoFrame() {
        ...
        buttonShellSort.addActionListener(actionEvent -> sortDemo(ShellSort::sort));
        ...
        buttonPerformanceTest.addActionListener(actionEvent -> {
            ...
            Consumer<Integer[]>[] sorts = new Consumer[]{
                    (Consumer<Integer[]>) ShellSort::sort,
            };
            int[] sizes = {
    ...
    */
    ...
    sortNames - Имена метод сортировки
    sorts - Список сортировок в виде массива Consumer
    sizes - Размеры массивов, для которых надо провести тестирование
    */
    private void performanceTestDemo(String[] sortNames, Consumer<Integer[]>[] sorts, int[] sizes, boolean partiallyOrdered) {
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Быстродействие сортировки Шелла",
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonShellSort = new JButton();
        buttonShellSort.setText("Сортировка Шелла (Shell Sort)");
        panel2.add(buttonShellSort, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        buttonPerformanceTest.setText("Тест производительности 1");
        panel3.add(buttonPerformanceTest, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
